...
```
git clone git@github.com:your-username/phonegap-plugin-csdk-asset-browser.git
```
...
git remote add upstream https://github.com/CreativeSDK/phonegap-plugin-csdk-asset-browser
```
